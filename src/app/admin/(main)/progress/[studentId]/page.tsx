// SC-A11 — chi tiết tiến độ 1 学生 (コース別の進捗). Chỉ ADMIN.
    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "320px 1fr", gap: 24, alignItems: "start" }}>
        ...
        <Card style={{ textAlign: "center", position: "sticky", top: 24 }}>
          ...
          >
            {(student.name || student.nameKana)[0]}
          </div>
          <div style={{ fontSize: 19, fontWeight: 900 }}>{student.name || student.nameKana}</div>
          <div style={{ fontSize: 12.5, color: T.muted2, marginTop: 3 }}>
