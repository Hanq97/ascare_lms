...
// Bộ icon — port 1:1 từ design bundle (lms/ui.jsx `I`). Stroke = currentColor để đổi màu theo context.
export const I: Record<string, ReactElement> = {
  ...
  key: (
    <svg
      ...
      strokeWidth="2"
    >
      <path d="M21 2l-2 2m-7.6 7.6a5 5 0 1 0-7 7 5 5 0 0 0 7-7zm0 0L15 8m0 0l3 3 3-3-3-3" />
    </svg>
  ),
  trash: (
    <svg
  ...
  idcard: (
    ...
    >
      ...
      <path d="M5 16c.7-1.4 2-2 3.5-2s2.8.6 3.5 2M14 9h5M14 13h5" />
    </svg>
  ),
};
